...
<head>
    ...
    <link rel="shortcut icon" href="http://localhost:8000/img/favicon.html">

    <title>Inbox</title>

    <!-- Bootstrap core CSS -->
    <link href="http://localhost:8000/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://localhost:8000/css/bootstrap-reset.css" rel="stylesheet">
    <!--external css-->
    <link href="http://localhost:8000/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="http://localhost:8000/assets/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
    ...
    <!--[if lt IE 9]>
    <script src="http://localhost:8000/js/html5shiv.js"></script>
    ...
    <header class="header white-bg">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="http://localhost:8000/img/avatar-mini.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="http://localhost:8000/img/avatar-mini2.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="http://localhost:8000/img/avatar-mini3.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                    <span class="photo">
                                        <img alt="avatar" src="http://localhost:8000/img/avatar-mini4.jpg"></span>
                                <span class="subject">
        ...
        <div class="top-nav ">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="http://localhost:8000/img/avatar1_small.jpg">
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="general.html">لیست کاربران</a></li>
...
<script src="http://localhost:8000/js/jquery.scrollTo.min.js"></script>
<script src="http://localhost:8000/js/jquery.nicescroll.js" type="text/javascript"></script>

<!-- BEGIN:File Upload Plugin JS files-->
<script src="http://localhost:8000/public/assets/jquery-file-upload/js/vendor/jquery.ui.widget.js"></script>
<!-- The Templates plugin is included to render the upload/download listings -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/vendor/tmpl.min.js"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/vendor/load-image.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/vendor/canvas-to-blob.min.js"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/jquery.fileupload.js"></script>
<!-- The File Upload file processing plugin -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<script src="http://localhost:8000/assets/jquery-file-upload/js/jquery.fileupload-ui.js"></script>


<!--common script for all pages-->
<script src="http://localhost:8000/js/common-scripts.js"></script>
